...
func main() {
	...
	http.HandleFunc("/system/group", NBApis.SystemGroupURL)
	http.HandleFunc("/system/createSchedule", NBApis.CraeteSchedule)
	http.HandleFunc("/system/zone", NBApis.SystemZoneURL)
	http.HandleFunc("/system/scu/schedule", NBApis.SetScheduleForScu)
	http.HandleFunc("/system/gateway/schedule", NBApis.SetScheduleForSgu)
	...
	http.HandleFunc("/system/streetlamp/attachedSchedule", NBApis.SCUView)
