...
func downloadLocation(w http.ResponseWriter, r *http.Request)  {
	...
	row = sheet.AddRow()
	cell = row.AddCell()
	cell.SetStyle(sty);cell.Value = "Usr";cell = row.AddCell();	cell.SetStyle(sty);cell.Value = "Pno";cell = row.AddCell();cell.SetStyle(sty);	cell.Value = "Mun";cell = row.AddCell();cell.SetStyle(sty);	cell.Value = "Ward";cell = row.AddCell();cell.SetStyle(sty);	cell.Value = "Loc";cell = row.AddCell();cell.SetStyle(sty);	cell.Value = "Rw";cell = row.AddCell();	cell.SetStyle(sty);cell.Value = "Pso";cell = row.AddCell();cell.SetStyle(sty);	cell.Value = "Pla";cell = row.AddCell();	cell.SetStyle(sty);cell.Value = "Height";cell = row.AddCell();cell.SetStyle(sty);	cell.Value = "Pty";cell = row.AddCell();	cell.SetStyle(sty);cell.Value = "Opw";cell = row.AddCell();cell.SetStyle(sty);	cell.Value = "Lf";cell = row.AddCell();cell.SetStyle(sty);	cell.Value = "Earth";cell = row.AddCell();cell.SetStyle(sty);	cell.Value = "Phase";cell = row.AddCell();cell.SetStyle(sty);	cell.Value = "Fun";cell = row.AddCell();cell.SetStyle(sty);	cell.Value = "Lul";cell = row.AddCell();cell.SetStyle(sty);	cell.Value = "Lat";cell = row.AddCell();cell.SetStyle(sty);	cell.Value = "Lng";
	...
	for ;rows.Next(); {
		...
		cell.SetStyle(sty);cell.Value = str.Usr;cell = row.AddCell();	cell.SetStyle(sty);cell.Value = str.Pno;cell = row.AddCell();cell.SetStyle(sty);	cell.Value = str.Mun;cell = row.AddCell();cell.SetStyle(sty);	cell.Value = str.Ward;cell = row.AddCell();cell.SetStyle(sty);	cell.Value = str.Loc;cell = row.AddCell();cell.SetStyle(sty);	cell.Value = str.Rw;cell = row.AddCell();	cell.SetStyle(sty);cell.Value = str.Pso;cell = row.AddCell();cell.SetStyle(sty);	cell.Value = str.Pla;cell = row.AddCell();	cell.SetStyle(sty);cell.Value = str.Height;cell = row.AddCell();cell.SetStyle(sty);	cell.Value = str.Pty;cell = row.AddCell();	cell.SetStyle(sty);cell.Value = str.Opw;cell = row.AddCell();cell.SetStyle(sty);	cell.Value = str.Lf;cell = row.AddCell();cell.SetStyle(sty);	cell.Value = str.Earth;cell = row.AddCell();cell.SetStyle(sty);	cell.Value = str.Phase;cell = row.AddCell();cell.SetStyle(sty);	cell.Value = str.Fun;cell = row.AddCell();cell.SetStyle(sty);	cell.Value = str.Lul;cell = row.AddCell();cell.SetStyle(sty);	cell.Value = str.Lat;cell = row.AddCell();cell.SetStyle(sty);	cell.Value =str.Lng;
	}
...
func main() {
	...
	logger.Println("Reconnecting TCP connections")
...
//NB Services
	...
	http.HandleFunc("/system/gateway", NBApis.GatewayStreetLampControll)
	http.HandleFunc("/system/group", NBApis.GroupStreetLampControll)
	http.HandleFunc("/system/createSchedule", NBApis.CraeteSchedule)
