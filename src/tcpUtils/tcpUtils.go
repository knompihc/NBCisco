...
func (TcpUtilsStructPtr *TcpUtilsStruct) AddByteToOutputBuff(newByte byte) {
	...
	/*if (TcpUtilsStructPtr.outputBufferDipstick < len(TcpUtilsStructPtr.responseLineBuff)){
	      TcpUtilsStructPtr.responseLineBuff[TcpUtilsStructPtr.outputBufferWritePtr] = newByte
	                  TcpUtilsStructPtr.outputBufferWritePtr++
	      TcpUtilsStructPtr.outputBufferWritePtr &= (len(TcpUtilsStructPtr.responseLineBuff)-1)
	      TcpUtilsStructPtr.outputBufferDipstick++
...
func (TcpUtilsStructPtr *TcpUtilsStruct) ParseInputPacket() {
	...
	//testing delimeters
	test_start_delimeter := TcpUtilsStructPtr.ReadOneByteFromInput()
	logger.Println("test_start_delimeter from SGU", test_start_delimeter)
	logger.Println("start delimiter from Server", StartingDelimeter)
