...
func forcsv(fname string,ts string) string{
	...
	row = sheet.AddRow()
	cell = row.AddCell()
	cell.SetStyle(sty);cell.Value = "SGU ID";cell = row.AddCell();	cell.SetStyle(sty);cell.Value = "Timestamp";cell = row.AddCell();cell.SetStyle(sty);	cell.Value = "Vr";cell = row.AddCell();cell.SetStyle(sty);	cell.Value = "Vy";cell = row.AddCell();cell.SetStyle(sty);	cell.Value = "Vb";cell = row.AddCell();cell.SetStyle(sty);	cell.Value = "Ir";cell = row.AddCell();	cell.SetStyle(sty);cell.Value = "Iy";cell = row.AddCell();cell.SetStyle(sty);	cell.Value = "Ib";cell = row.AddCell();	cell.SetStyle(sty);cell.Value = "Pf";cell = row.AddCell();cell.SetStyle(sty);	cell.Value = "KW";cell = row.AddCell();	cell.SetStyle(sty);cell.Value = "KVA";cell = row.AddCell();cell.SetStyle(sty);	cell.Value = "KVAH";cell = row.AddCell();cell.SetStyle(sty);	cell.Value = "rKVAH";cell = row.AddCell();cell.SetStyle(sty);	cell.Value = "Run_Hours";cell = row.AddCell();cell.SetStyle(sty);	cell.Value = "Freq";
	...
	for stmt1.Next(){
		...
		cell.SetStyle(sty);cell.Value = sgid;cell = row.AddCell();	cell.SetStyle(sty);cell.Value = ti;cell = row.AddCell();cell.SetStyle(sty);	cell.Value = Vr;cell = row.AddCell();cell.SetStyle(sty);	cell.Value = Vy;cell = row.AddCell();cell.SetStyle(sty);	cell.Value = Vb;cell = row.AddCell();cell.SetStyle(sty);	cell.Value = Ir;cell = row.AddCell();	cell.SetStyle(sty);cell.Value = Iy;cell = row.AddCell();cell.SetStyle(sty);	cell.Value = Ib;cell = row.AddCell();	cell.SetStyle(sty);cell.Value = Pf;cell = row.AddCell();cell.SetStyle(sty);	cell.Value = KW;cell = row.AddCell();	cell.SetStyle(sty);cell.Value = KVA;cell = row.AddCell();cell.SetStyle(sty);	cell.Value = KVAH;cell = row.AddCell();cell.SetStyle(sty);	cell.Value = rKVAH;cell = row.AddCell();cell.SetStyle(sty);	cell.Value = Run_Hours;cell = row.AddCell();cell.SetStyle(sty);	cell.Value = freq;
	}
	//defer stmt1.Close()
